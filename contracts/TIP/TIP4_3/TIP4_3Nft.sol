...
import "@itgold/everscale-tip/contracts/TIP4_3/interfaces/ITIP4_3NFT.sol";
import "@itgold/everscale-tip/contracts/TIP4_3/Index.sol";

/// This contract implements TIP4_1Collection, ITIP4_3NFT (add indexes)
abstract contract TIP4_3Nft is TIP4_1Nft, ITIP4_3NFT {
    ...
    function _buildIndexCode(address collection, address owner) internal view virtual returns (TvmCell) {
        TvmBuilder salt;
        salt.store("nft");
    ...
    function _buildIndexState(TvmCell code, address nft) internal pure virtual returns (TvmCell) {
